...
p2 ──→ même objet que p1 (même objet que p1 ou nouvel objet ?)
...
- p2 pointe vers p1 (même objet que p1)

**Ligne 5 :** `Personne p3 = new Personne("Alice", 25);`
- p3 pointe vers cet objet (nouvel objet)
...
- p1 == p3 → non (comparent-ils la même adresse mémoire ?)
