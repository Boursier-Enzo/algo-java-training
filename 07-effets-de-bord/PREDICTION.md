...
Réponse : car dans modifierNombre n est une copie de nombre alors que dans modifierTableau tab est une copie de l'adresse de tableau du coup ça point sur la même valeur.
